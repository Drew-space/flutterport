...
export const metadata: Metadata = {
  title: "Blog | Drew",
  description: "Thoughts on frontend and app development",
};
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-3">
          <h1 className="font-custom text-3xl font-bold tracking-tight text-neutral-900 md:text-3xl dark:text-neutral-50">
            <span className="link--elara">Blog</span>
          </h1>

          <p className="text-s font-custom2 mt-1 max-w-xl leading-relaxed tracking-tight text-neutral-600 dark:text-neutral-400">
            I'm a frontend developer who's fallen hard for app development —
            building things across web and mobile.
          </p>
        </div>
        ...
        <div className="mt-16 flex flex-col items-center justify-center py-20 text-center">
          <p className="font-custom text-lg font-semibold text-neutral-800 dark:text-neutral-200">
            No posts yet
          </p>
          <p className="font-custom2 mt-2 max-w-sm text-sm text-neutral-500 dark:text-neutral-400">
            I'm working on some write-ups about the projects I've been building.
            Check back soon.
          </p>
        </div>
      </div>
