  ...
  const socials = [
    {
      name: "GitHub",
      icon: Github,
      action: () => window.open("https://github.com/Drew-space", "_blank"),
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
      action: () =>
        window.open(
          "https://linkedin.com/in/chukwuka-enudeme-930b9a378",
          "_blank",
        ),
    },
    {
      name: "X",
      icon: Twitter,
      action: () => window.open("https://ix-drew.vercel.app/", "_blank"),
    },
    {
      name: "Email",
      icon: Mail,
      action: () => (window.location.href = "mailto:chukwukaenudeme@gmail.com"),
    },
  ];
      ...
      <Container className="mx-auto min-h-[200vh] px-8 pt-24 md:p-20 md:pb-10">
        ...
        <div className="text-secondary font-custom2 text-s mt-1">
          <p>
            <span className="font-semibold text-neutral-950 dark:text-neutral-100"></span>
            <span className="text-neutral-700 dark:text-neutral-300">
              Self-taught dev shipping full apps solo, from idea to production.
            </span>
          </p>
          ...
          <p>
            <span className="font-bold text-neutral-950 dark:text-neutral-100"></span>
            <span className="text-neutral-700 dark:text-neutral-300">
              Currently deep in Flutter, building cross platfrom apps from
              ground up.
            </span>
          </p>
          ...
          <p>
            <span className="font-semibold text-neutral-950 dark:text-neutral-100"></span>
            <span className="text-neutral-700 dark:text-neutral-300">
              Rooted in web, hungry for mobile, chasing both.
            </span>
          </p>
        </div>
